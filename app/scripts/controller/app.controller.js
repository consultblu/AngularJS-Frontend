    ...
    if ($stateParams.page === 'blog') {
      ...
      $scope.$watchGroup(['contentBlocks','contentBlocks.currentPage'], function(val) {			 
        dataFactory.getBlogData('get_recent_posts',$scope.contentBlocks.currentPage).success(function(data) {
          $blogObject = $filter('filter')($scope.contentBlocks, { content_block_type: 'blog' })[0];
    ...
    app.controller('contactUsCtrl', ['$scope', '$rootScope', '$filter', '$modal', 'dialogs', '$http', 'dataFactory', '$state', '$stateParams', '$location', '$timeout', '$window', function($scope, $rootScope, $filter, $modal, dialogs, $http, dataFactory, $state, $stateParams, $location, $timeout, $window) {
        ...
        $scope.xmail = function(name,xmailvar) {
          ...
          for (i = 0; i < obj.length; i++) {
            if (obj[i]) {
              switch(name) {
                case 'Africa' : email = 'KRoeser'; break;
                case 'Alabama' : email = 'AWeiss'; break;
                case 'Alaska' : email = 'JTanner'; break;
                case 'Arizona' : email = 'KCoia'; break;
                case 'Arkansas' : email = 'ASt.Germain'; break;
                case 'Asia' : email = 'KDaly'; break;
                case 'Asia & India Subcontinent' : email = 'KDaly'; break;
                case 'Oceania & Pacific' : email = 'KDaly'; break;
                case 'Australia' : email = 'KDaly'; break;
                case 'Canada' : email = 'KDaly'; break;
                case 'China' : email = 'KDaly'; break;
                case 'HongKong' : email = 'KDaly'; break;
                case 'Singapore' : email = 'KDaly'; break;
                case 'Los Angeles' : email = 'KCoia'; break;
                case 'San Diego / SouthernCA' : email = 'KDaly'; break;
                case 'San Francisco / Northern CA' : email = 'KCoia'; break;
                case 'Alberta / Calgary' : email = 'JTanner'; break;
                case 'Halifax / NovaScotia' : email = 'AWeiss'; break;
                case 'Vancouver / BritishCol' : email = 'JTanner'; break;
                case 'Manitoba / Winnepeg' : email = 'JTanner'; break;
                case 'Montreal / Quebec' : email = 'ASt.Germain'; break;
                case 'Toronto / Ontario' : email = 'AWeiss'; break;
                case 'Carribbean' : email = 'JContreras'; break;
                case 'Trinidad' : email = 'JContreras'; break;
                case 'Central & South America' : email = 'JContreras'; break;
                case 'Central America' : email = 'JContreras'; break;
                case 'South America' : email = 'JContreras'; break;
                case 'Colorado' : email = 'KRoeser'; break;
                case 'Connecticut' : email = 'SSmith'; break;
                case 'Delaware' : email = 'KSeeley'; break;
                case 'Middle East' : email = 'KRoeser'; break;
                case 'Dubai' : email = 'KRoeser'; break;
                case 'Europe' : email = 'KRoeser'; break;
                case 'Florida' : email = 'JContreras'; break;
                case 'Georgia' : email = 'AWeiss'; break;
                case 'Hawaii' : email = 'JTanner'; break;
                case 'Hong Kong' : email = 'KDaly'; break;
                case 'HPG HK' : email = 'KDaly'; break;
                case 'Idaho' : email = 'SSmith'; break;
                case 'Illinois' : email = 'ADobin'; break;
                case 'Indiana' : email = 'ADobin'; break;
                case 'Iowa' : email = 'ADobin'; break;
                case 'Kansas' : email = 'SSmith'; break;
                case 'Kentucky' : email = 'JContreras'; break;
                case 'Louisiana' : email = 'KDaly'; break;
                case 'Maine' : email = 'SSmith'; break;
                case 'Maryland' : email = 'KSeeley'; break;
                case 'Massachusetts' : email = 'SSmith'; break;
                case 'Michigan' : email = 'ADobin'; break;
                case 'Minnesota' : email = 'ADobin'; break;
                case 'Mississippi' : email = 'AWeiss'; break;
                case 'Missouri' : email = 'SSmith'; break;
                case 'Montana' : email = 'SSmith'; break;
                case 'Nebraska' : email = 'ADobin'; break;
                case 'North America' : email = '?'; break;
                case 'Nevada' : email = 'KDaly'; break;
                case 'New Hampshire' : email = 'SSmith'; break;
                case 'New Jersey(Northern)' : email = 'SSmith'; break;
                case 'Atlantic City' : email = 'KSeeley'; break;               
                case 'New Mexico' : email = 'ASt.Germain'; break;
                case 'New York' : email = 'TSauer'; break;
                case 'North Carolina' : email = 'AWeiss'; break;
                case 'North Dakota' : email = 'ADobin'; break;
                case 'Ohio' : email = 'JContreras'; break;
                case 'Oklahoma' : email = 'ASt.Germain'; break;
                case 'Oregon' : email = 'JTanner'; break;
                case 'Pennsylvania' : email = 'KSeeley'; break;
                case 'Philadelphia Area' : email = 'KSeeley'; break;
                case 'Pittsburgh Area' : email = 'JContreras'; break;
                case 'Rhode Island' : email = 'SSmith'; break;
                case 'South Carolina' : email = 'AWeiss'; break;
                case 'South Dakota' : email = 'ADobin'; break;
                case 'Tennessee' : email = 'AWeiss'; break;
                case 'Texas' : email = 'ASt.Germain'; break;
                case 'Utah' : email = 'KCoia'; break;
                case 'Vermont' : email = 'SSmith'; break;
                case 'Virginia' : email = 'KSeeley'; break;
                case 'Washington' : email = 'JTanner'; break;
                case 'Washington, D.C.' : email = 'KSeeley'; break;
                case 'West Virginia' : email = 'KSeeley'; break;
                case 'Wisconsin' : email = 'ADobin'; break;
                case 'Wyoming' : email = 'ADobin'; break;
        ...
        $scope.getSamples = function(query, loadMore) {
          ...
          console.log("someone called getSamples!!!");
            ...
            dataFactory.getData($scope.sample_url).success(function(data) {             
              ...
              if (loadMore == 'false') {
                if(keys.length > 0){
                  $scope.samples = angular.element.map(data, function(value, index) {return [value];});
